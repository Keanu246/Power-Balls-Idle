...
var baseHealthMulti = 1.25; 
var startingBalls = 10; 
var balls = [ 
  {active:false,x:200,y:200,dx:.707,dy:.707,color:"Blue",radius:20,bDamage:10,rank:0,cost:10,id:0,clone:false,speed:4}, 
  {active:false,x:300,y:300,dx:.707,dy:-.707,color:"Green",radius:20,bDamage:1000,rank:0,cost:100,id:1,clone:false,speed:4}, 
  {active:false,x:100,y:100,dx:-.707,dy:.707,color:"Red",radius:30,bDamage:10000,rank:0,cost:1000,id:2,clone:false,speed:3}, 
  {active:false,x:400,y:400,dx:-.707,dy:-.707,color:"Yellow",radius:25,bDamage:100000,rank:0,cost:10000,id:3,clone:false,speed:5}, 
  {active:false,x:900,y:300,dx:-.707,dy:.707,color:"Orange",radius:48,bDamage:40000000,rank:0,cost:1000000,id:4,clone:false,speed:2}, 
  {active:false,x:1000,y:200,dx:-.707,dy:-.707,color:"Purple",radius:5,bDamage:5000000000,rank:0,cost:1000000000,id:5,clone:false,speed:8}, 
  {active:false,x:1200,y:300,dx:.707,dy:.707,color:"Cyan",radius:15,bDamage:185000000000,rank:0,cost:1000000000000,id:6,clone:false,speed:4}, 
  {active:false,x:1100,y:400,dx:-.707,dy:-.707,color:"Pink",radius:40,bDamage:4000000000000,rank:0,cost:1000000000000000,id:7,clone:false,speed:8}, 
  {active:false,x:300,y:500,dx:.707,dy:-.707,color:"Turquoise",radius:20,bDamage:800000000000000,rank:0,cost:1000000000000000000,id:8,clone:false,speed:4}, 
  {active:false,x:600,y:200,dx:-.707,dy:.707,color:"Maroon",radius:2,bDamage:400000000000000000,rank:0,cost:10000000000000000000000,id:9,clone:false,speed:4} 
]; 
var clickBalls = [ 
